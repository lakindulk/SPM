    ...
    <div style={{ paddingTop: "1vh", paddingBottom: "1vh" }}>
      <div className="btn-container">
        <div className="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div className="col">
            <Link to="/">
              <Button className="btn" variant="secondary">Lab Reports</Button>
            </Link>
          </div>
          <Link to="/">
            <div className="col">
              <Button className="btnr" variant="secondary">Notifications</Button>
            </div>
          </Link>
      ...
      <div className="profile-container">
        <h1 style={{fontSize:"30px", paddingTop: "7vh",}}>Welcome {username}.. Have a good day..</h1>
