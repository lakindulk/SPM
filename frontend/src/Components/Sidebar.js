...
<div>
                <ul className="nav flex-column sidebar bg-dark">
                    ...
                    <li className="nav-item">
                    <Link to="/admin/homescreenmanagement" style={{ color: 'white', textDecoration: 'inherit'}} ><i className="fa fa-bar-chart fa-lg"></i> Home Screen Management<hr className="bg-warning" /></Link>
                    </li>
                    <li className="nav-item">
