...
export class EditLabReport extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:6500/codebusters/api/labreport/get/${this.props.match.params.id}`)
            .then((response) => {
    ...
    onSubmit(e) {
        ...
        if (isValid) {
            ...
            axios.put(`http://localhost:6500/codebusters/api/labreport/edit/${id}`, labreport)
                .then(response => {
